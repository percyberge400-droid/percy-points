    ...
    class Program
    {
        static void Main()
        {
            while (true)
            {
                ...
                Console.WriteLine("5 = Encrypt Plain Text → Get Encrypted String");
                Console.WriteLine("6 = Decrypt Plain Text → Get Original String");
                ...
                else if (choice == "5") EncryptPlainText();
                else if (choice == "6") DecryptPlainText();
                else
                {
        ...
        // ---------------------------------------------------
        // OPTION 5: Encrypt Plain Text
        // ---------------------------------------------------
        private static void EncryptPlainText()
        {
            Console.Clear();
            Console.WriteLine("=== ENCRYPT PLAIN TEXT ===\n");
            ...
            try
            {
                string encrypted = AesEncryptionHelper.Encrypt(plainText);
        ...
        // ---------------------------------------------------
        // OPTION 6: Decrypt Plain Text
        // ---------------------------------------------------
        private static void DecryptPlainText()
        {
            Console.Clear();
            Console.WriteLine("=== DECRYPT PLAIN TEXT ===\n");
            ...
            try
            {
                string decrypted = AesEncryptionHelper.Decrypt(encryptedText.Trim());
            ...
            {
                Console.WriteLine($"\n❌ ERROR: {ex.Message}");
                Console.WriteLine("⚠️  Make sure the input is a valid encrypted string generated by this tool.");
            }
